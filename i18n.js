...
const TRANSLATIONS = {
  id: {
    ...
    faq3_a:         'Setiap blok punya "<strong class="text-white">hash</strong>" — semacam sidik jari unik yang dibuat dari data di dalamnya. Kalau ada satu karakter yang diubah, hash-nya berubah total. Dan karena setiap blok mencantumkan hash blok sebelumnya, kamu harus ubah <em>semua blok sejak awal</em> — dan melakukannya lebih cepat dari ribuan komputer lain. Hampir mustahil! 😅',
    ...
    mod02_tx3: '<strong class="text-white">Transaksi masuk "mempool"</strong> — ruang tunggu di mana transaksi-transaksi menunggu untuk diproses para miner.',
...
function toggleLanguage() {
  ...
  // Toast feedback (pakai showToast dari wallet.js jika tersedia)
